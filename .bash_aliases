...
alias enums='yarn php batch generate-enums-from-schema'
alias f='yarn test:php'
alias h='yarn test:php'
alias j='yarn test:jsw'
alias links='yarn dev:links'
alias dbsync='yarn php batch dbsync'
alias m='mysql -h 127.0.0.1 -uuser -ppassw0rd'
alias models='yarn php generate-enums-from-schema'
alias p='ping www.yahoo.com'
alias schema_patch='yarn php batch ApplySchemaPatch --mysql'
